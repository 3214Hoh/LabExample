...
2. **Нахождение второго минимума:**  
  Программа находит минимальное число из `a`, `b`, `c`, `d`.
  Пример: пусть `a` - минимальное, тогда программа ищет минимальное из `b`, `c`, `d`.
  Соответсвенно то же самое и для других букв

4. **Вывод результата:**
   На экран выводится второй минимальный элемент.
